						...
						//console.log(customData);
							...
							//console.log(supplierData);
								...
								//console.log(suporddetailData);
									...
									res.render('supplierpendedit', { productData:productData,orderData:orderData,orderdetailData:orderdetailData,customData:customData,supplierData:supplierData,suporddetailData:suporddetailData,yetpendordData:yetpendordData,okpendordData:okpendordData,user : req.user});    
