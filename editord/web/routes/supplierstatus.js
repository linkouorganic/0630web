					...
					//console.log(supplierData);
						...
						//console.log(suporddetailData);
							...
							console.log(yetpendordData);
								...
								res.render('supplierstatus', {csrfToken: req.csrfToken(), productData:productData,orderData:orderData,orderdetailData:orderdetailData,customData:customData,supplierData:supplierData,suporddetailData:suporddetailData,yetpendordData:yetpendordData,okpendordData:okpendordData,user : req.user});    
								});
