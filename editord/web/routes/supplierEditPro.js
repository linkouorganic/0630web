									...
									console.log(yetpendordData);
										...
										console.log(editpendordData);
											...
											if(No.length=='1'){
												...
												var one={SerNo,ProQuantity,Amount,Product_ProId,OrdStatus,Order_OrdNo,UnitPrice,Quantity,Weight};
												console.log("one1");
												console.log(one);
												console.log("one1");
										...
										res.render('supplierordedit', { productData:productData,orderData:orderData,orderdetailData:orderdetailData,customData:customData,supplierData:supplierData,suporddetailData:suporddetailData,yetpendordData:yetpendordData,okpendordData:okpendordData,editpendordData:editpendordData,user : req.user});    
