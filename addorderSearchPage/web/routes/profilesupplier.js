...
router.get('/', isLoggedIn, function(req, res) {
	...
	console.log(orderData);
		...
		console.log(orderdetailData);
			...
			res.render('profilesupplier.ejs', {csrfToken: req.csrfToken(), messages: messages, hasErrors: messages.length > 0,user : req.user,orderData:orderData,orderdetailData:orderdetailData,productData:productData});
