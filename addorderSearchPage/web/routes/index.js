...
router.get('/profile', isLoggedIn, function(req, res) {
	...
	console.log(orderData);
		...
		console.log(orderdetailData);
			...
			console.log(productData);
			var messages = req.flash('error');
			res.render('profile.ejs', {csrfToken: req.csrfToken(), messages: messages, hasErrors: messages.length > 0,user : req.user,orderData:orderData,orderdetailData:orderdetailData,productData:productData});
