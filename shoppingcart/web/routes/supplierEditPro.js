								...
								//console.log(suporddetailData);
									...
									console.log(yetpendordData);
										...
										console.log(editpendordData);
											...
											pool.query('UPDATE linkouorganicdb.`order` SET OrdDate=?, FinishDate=?, createtime=?, memo=? where OrdNo=?', [OrdDate, FinishDate, createtime, memo, OrdNo], function(err, rows, fields) {
