										...
										var editordData;
											...
											pool.query('INSERT INTO custom SET ?', newCustomData, function(err, rows, fields) {
												...
												pool.query('SELECT id FROM custom  ORDER BY id DESC LIMIT 0 , 1', function(err, results){
													...
													//查order.OrdNo
													pool.query('SELECT OrdNo FROM linkouorganicdb.`order`  ORDER BY OrdNo DESC LIMIT 0 , 1  ',function(err, results){
														...
														//存入order
														pool.query('INSERT INTO linkouorganicdb.`order` SET ?', newUserMysql, function(err, rows, fields) {
